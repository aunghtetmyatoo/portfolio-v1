                ...
                <div class="max-w-[570px] mb-12 lg:mb-0">
                    ...
                    <a href="mailto:aunghtetmyatoo888@gmail.com">
                        <div class="flex mb-8 max-w-[370px] w-full">
                            <div
                                class="max-w-[60px] sm:max-w-[70px] w-full h-[60px] sm:h-[70px] flex items-center justify-center mr-6 overflow-hidden bg-primary bg-opacity-5 text-primary dark:text-gray-300 rounded">
                        ...
                        submitForm(event) {
                            ...
                            fetch(`/contact/submit`, {
                                ...
                                .then(result => {
                                    ...
                                    this.successMessage = 'Thanks for your contact request.';
                                })
                                .catch(res => {
                                    if (res.status === 422) {
